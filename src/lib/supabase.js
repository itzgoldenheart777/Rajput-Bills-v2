...
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://zieaqamgvoyuoaupmwdj.supabase.co'
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InppZWFxYW1ndm95dW9hdXBtd2RqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYxMDQzOTQsImV4cCI6MjA5MTY4MDM5NH0.e3KruQyO5g6KaPkCk3xg_oYP1f3yGzNmgSauWQpqcR8'

console.log('Supabase check:', { url: !!supabaseUrl, key: !!supabaseAnonKey, isFallback: !import.meta.env.VITE_SUPABASE_URL })
